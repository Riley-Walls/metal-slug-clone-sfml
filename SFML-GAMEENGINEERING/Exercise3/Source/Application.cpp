...
//BMRK_WINDOW_SIZE
: mWindow(sf::VideoMode(1024, 642), "States", sf::Style::Close)
, mTextures()
, mFonts()
, mPlayer()
...
{
	//Update static mouse position
	Application::mouseX = sf::Mouse::getPosition(mWindow).x;
	Application::mouseY = sf::Mouse::getPosition(mWindow).y;
